                    ...
                    <div class="hero-buttons">
                        ...
                        <div class="grid-container fluid">
                            <ul class="menu align-right">
                                <li>
                                    <a class="button button--secondary--active" href="">Home</a>
                                </li>
                                <li>
                                    <a class="button button--secondary" href="">Climatespace</a>
                                </li>
                                <li>
                                    <a class="button button--secondary" href="">Environmental</a>
                                </li>
                                <li>
                                    <a class="button button--secondary" href="">H&amp;S</a>
                                </li>
                            </ul>
                        </div>
                    </div>
