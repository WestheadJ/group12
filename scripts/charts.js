...
window.onload = () => {
  ...
  .then((json)=>{
    ...
    var renderContainer = document.getElementsByClassName('gird-stack')
    ...
    json.configs.forEach(item=>{
      ...
      var stackPrint = stack.replace(","," ")
      console.log(stackPrint)

      
      // Ready a div to become a row
      let item = document.createElement("div").setAttribute("class","grid-stack-item").setAttribute(stackPrint)
      ...
      //   var renderContainer2  = document.getElementByClassName('')
